...
// Includes a dynamic Proxy Rotator and a strict Sukebei Poison Filter.
//===============
...
//===============
// Wir nutzen die funktionierenden Proxies, filtern aber Sukebei strikt raus
let PROXIES = [
    "https://nyaa.land",
    "https://nyaa.ink",
    "https://nyaa.iss.one",
...
async function searchNyaaForAnime(romajiTitle) {
    ...
    const fetchPromise = (async () => {
        ...
        allItems.forEach(item => {
            ...
            //===============
            // SUKEBEI POISON FILTER
            // Wenn ein Proxy heimlich auf Sukebei umleitet, blockieren wir das hier anhand der Text-Kategorien!
            //===============
            const catLower = categoryName.toLowerCase();
            if (catLower.includes("art") || catLower.includes("real life") || catLower.includes("doujinshi") || catLower.includes("pictures")) {
                return; 
            }

            if (!categoryId.startsWith("1_") && !categoryId.startsWith("4_")) {
                return;
            }
