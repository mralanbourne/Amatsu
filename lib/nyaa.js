...
// Utility function: Sets the Nyaa cache and replaces old entries
...
// Utility function: Retrieves data and rotates the cache position
...
//===============
// Searches Nyaa for matching torrents using in-memory caching
...
async function searchNyaaForAnime(romajiTitle) {
    ...
    const fetchPromise = (async () => {
        ...
        //===============
        // Added &s=seeders&o=desc to the RSS URL.
        // This forces Nyaa to show us the most popular batches and episodes 
        // instead of the 75 most recent spam or movie uploads.
        //===============
        const rssUrl = "https://nyaa.si/?page=rss&c=1_0&f=0&q=" + encodedQuery + "&s=seeders&o=desc";
