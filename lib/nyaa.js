//===============
// AMATSU NYAA SCRAPER - FULLY UNLOCKED
...
async function searchNyaaForAnime(romajiTitle) {
    ...
    const fetchPromise = (async () => {
        ...
        //===============
        // Changed category from c=1_0 (Anime only) to c=0_0 (All categories).
        // This fully unlocks Live-Action, Tokusatsu (like Kamen Rider), and other media, 
        // turning Amatsu into a truly universal Nyaa gateway.
        //===============
