...
async function getSeasonalAnime(stremioType = "series") {
    const formats = stremioType === "movie" ? ["MOVIE"] : ["TV", "TV_SHORT", "ONA", "OVA"];
...
module.exports = { searchAnime, getAnimeMeta, getTrendingAnime, getTopAnime, getAiringAnime, getSeasonalAnime, getJikanMeta, fetchEpisodeDetails };
