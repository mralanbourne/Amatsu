...
// (Clean Architecture + Honest API Header + Anti-Spoofing Fix)
//===============
...
// ERLÄUTERUNG: Wir nutzen einen ehrlichen Header. 
// Gefälschte Chrome-Header führen zu TLS-Mismatch und provozieren 403 Cloudflare-Blocks!
...
async function checkRD(hashes, apiKey) {
    ...
    const performFetch = async () => {
        try {
            const results = {};
            let totalCached = 0;
            const chunkSize = 20; // Leicht erhöht für bessere Performance
