...
// (Clean Architecture + Forensic Logging + Quick Retry)
//===============
...
async function checkRD(hashes, apiKey) {
    ...
    const performFetch = async () => {
        try {
            ...
            // FIX: Bei einem 401 oder 403 Fehler nur 10 Sekunden cachen, damit der Nutzer sich nicht für eine ganze Stunde aussperrt!
