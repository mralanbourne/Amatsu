...
**What to expect:**
- Public Addon URLs may be temporarily unreachable. / The Addon will stop working
- Once the migration is complete, you will experience significantly faster stream resolution and search speeds.
- We are currently waiting for Oracle to finalize the instance provisioning.
